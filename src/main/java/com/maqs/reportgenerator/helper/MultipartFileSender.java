...
public class MultipartFileSender {
    ...
    private static final long DEFAULT_EXPIRE_TIME = 24 * 60 * 60 * 1000; // ..ms = 1 day.
    ...
    public void serveResource() throws Exception {
        ...
        String contentType = FileTypeMap.getDefaultFileTypeMap().getContentType(fileName); //MimeTypeUtils.probeContentType(filepath);
